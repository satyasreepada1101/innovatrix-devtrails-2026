...
2. Persona & Scenarios:
1.	Scenario 1 - Ravi - A Swiggy Rider from Bengaluru
...
2.	Scenario 2 - Priya, Zomato Rider, Delhi
...
3.	Scenario 3 - Arjun, Swiggy Rider, Mumbai
...
Basic	Rs.29/week	Rs.300
Standard	Rs.49/week	Rs.600
Plus	Rs.79/week	Rs.1,000
...
Frontend	React (PWA)
	Rider & Admin Interface
	Fast development, cross-platform, no app install required.
Backend	Node.js+ExpressAPI	API & Business Logic	Lightweight, real-time capable, and easy integration.
...
Platform	Custom (Simulated)	Mocked Zomato/Swiggy APIs for orders and earnings data Mocked Zomato/Swiggy APIs for orders and earnings data


Business Viability (The "Unicorn" Perspective)
